        ...
        <main className={styles.destination_container}>
          <div className={styles.destination_content}>
            ...
            {destinationState == "Moon" && (
              <Image src={moon} alt="moon" height={420} width={420} />
            )}
            {destinationState == "Mars" && (
              <Image src={mars} alt="mars" height={420} width={420} />
            )}
            {destinationState == "Europa" && (
              <Image src={europa} alt="europa" height={420} width={420} />
            )}
            {destinationState == "Titan" && (
              <Image src={titan} alt="titan" height={420} width={420} />
            )}
          </div>
