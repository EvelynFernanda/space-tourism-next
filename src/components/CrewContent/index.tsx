  ...
  return (
    <div className={styles.crewContent} >
      ...
      <div className={styles.crewContent_images}>
        ...
        {crew.name == "Douglas Hurley" && <Image src={ImgDouglas} alt="Douglas Hurley" height={556} width={453} />}
        {crew.name == "Mark Shuttleworth" && <Image src={ImgMark} alt="Mark Shuttleworth" height={556} width={453} />}
        {crew.name == "Victor Glover" && <Image src={ImgVictor} alt="Victor Glover" height={556} width={554} />}
        {crew.name == "Anousheh Ansari" && <Image src={ImgAnousheh} alt="Anousheh Ansari" height={556} width={453} />}
      </div>
    </div>
  );
